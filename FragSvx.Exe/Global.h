...
SvxEntry.cpp Declarations

 -- --*/
#pragma pack( push, 4 )
typedef union _SVXFLAGS
{
   DWORD    Flags;
   struct
   {
      /*
       * Specifies whether the COM SCM or the SCM started the service, based
       * on the presence of a -COM command line parameter.
       */
 ...
 */
extern SVXFLAGS g_ControlFlags;
